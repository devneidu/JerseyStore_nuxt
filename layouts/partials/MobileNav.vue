<template>
    <div id="sidebar" :class="[toggleSideBar ? 'sidebar-slide' : '']">
        <div class="side__Bar__logo text-center">
            <img src="/logo_white.png" alt="Jersey store logo" class="pt-4" width="160">
        </div>
